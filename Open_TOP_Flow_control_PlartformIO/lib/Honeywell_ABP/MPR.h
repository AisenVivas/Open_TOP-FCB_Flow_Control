...
private:
    ...
    const double _max_psi = 1.0;       // Maximum Pressure in PSI (From datasheet, depends on sensor type)
    ...
    const int SPI_CLOCK_SPEED = 2000000; // SPI clock speed (From datasheet)
};
